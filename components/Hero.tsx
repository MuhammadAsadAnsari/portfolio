...
export default function Hero() {
  ...
  return (
    <section
      ...
      className="relative mx-auto max-w-6xl px-4 pt-12 pb-16 md:pt-16 md:pb-24 scroll-mt-20"
    >
            ...
            <motion.div style={{ x, y }}>
              <div className="text-center md:text-left">
                ...
                <div className="mt-6 flex flex-wrap items-center justify-center md:justify-start gap-3 sm:gap-4">
                  <Link
                    href="#projects"
                    className="px-4 sm:px-5 py-2.5 rounded-xl bg-white text-[#11071F] text-sm font-semibold hover:opacity-90 transition"
                  >
                    View Projects
                  </Link>
                  <Link
                    href="#contact"
                    className="px-4 sm:px-5 py-2.5 rounded-xl border border-white/15 text-sm hover:border-white/30 transition"
                  >
                    Contact
                  </Link>
                </div>
      ...
      {/* Background grid (absolutely positioned, transparent) */}
      <div
        className="-z-10"
