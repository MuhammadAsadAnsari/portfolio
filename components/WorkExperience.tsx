...
const EXPERIENCES = [
  {
    title: "Senior Software Engineer | Aigumind",
    subtitle:
  ...
  {
    title: "Associate Node.js Engr | Tafsol Technologies",
    subtitle:
  ...
  {
    title: "MERN Stack Developer | Tesseract Innovations",
    subtitle:
  ...
  {
    title: "IT Instructor & Trainer | Aptech",
    subtitle:
  ...
  {
    title: "Web Developer Intern | TechnorayX",
    subtitle:
    ...
    <section id="work" className="mx-auto max-w-6xl px-4 pb-10 scroll-mt-20">
      ...
      <div className="grid md:grid-cols-2 gap-4">
        {EXPERIENCES.map((exp, idx) => (
          <WorkCard key={idx} title={exp.title} subtitle={exp.subtitle} period={exp.period} iconSrc={exp.iconSrc} />
        ))}
      </div>
    </section>
  );
